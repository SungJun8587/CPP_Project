...
DECLARE_DBASYNC_HANDLER_EX(CMySQLAsyncSrv, DBASYNC_ADD_PRODUCER_REQ)
{
...
DECLARE_DBASYNC_HANDLER_EX(CMySQLAsyncSrv, DBASYNC_GET_PRODUCER_REQ)
{
	PRODUCER_DATA_BATCH_REQ* pDBParam = (PRODUCER_DATA_BATCH_REQ*)pStAsync;
...
DECLARE_DBASYNC_HANDLER_EX(CMySQLAsyncSrv, DBASYNC_LIST_PRODUCER_REQ)
{
	PRODUCER_DATA_BATCH_REQ* pDBParam = (PRODUCER_DATA_BATCH_REQ*)pStAsync;
...
DECLARE_DBASYNC_HANDLER_EX(CMySQLAsyncSrv, DBASYNC_BULKADD_PRODUCER_REQ)
{
	PRODUCER_DATA_BATCH_REQ* pDBParam = (PRODUCER_DATA_BATCH_REQ*)pStAsync;
...
DECLARE_DBASYNC_HANDLER_EX(CMySQLAsyncSrv, DBASYNC_BULKADD_CONSUMER_REQ)
{
